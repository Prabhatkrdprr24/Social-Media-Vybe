...
const MessageArea = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try{
      ...
      console.error("Error sending message frontend message area handlesendmessage fn ", error);
    }
  }
  ...
  const getAllMessages = async () => {
    ...
    try{
      ...
      console.error("Error fetching all messages in MessageArea frontend getAllMessages fn", error);
    }
